...
function handleBtnClick() {
  const elementArr = [...listEl.children];
  console.log(elementArr);

  elementArr.forEach(liEl => liEl.textContent *= 2);
}
